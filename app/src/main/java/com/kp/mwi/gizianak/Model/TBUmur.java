...
public class TBUmur {
    ...
    public void TBUmur(){
        ...
        /*TINGGI BADAN TERDAHAP UMUR 0 - 5 TAHUN TITIK B LAKI-LAKI*/
            ...
            perawakan = "Perawakan Lumayan Tinggi";
            keterangan = "Tinggi badan anak Anda termasuk PERAWAKAN LUMAYAN TINGGI"
                    + "\n" + "\n"
                    + "Silahkan menggunakan kurva BERAT BADAN terhadap PANJANG/TINGGI BADAN untuk menentukan status gizinya."
            ;
        }
        ...
        /*TINGGI BADAN TERDAHAP UMUR 0 - 5 TAHUN TITIK D LAKI-LAKI*/
            ...
            perawakan = "Perawakan Kurang Tinggi";
            keterangan = "Tinggi badan anak Anda termasuk PERAWAKAN KURANG TINGGI"
                    + "\n" + "\n"
                    + "Silahkan menggunakan kurva BERAT BADAN terhadap PANJANG/TINGGI BADAN untuk menentukan status gizinya."
                    + "\n" + "\n"
